...
function tambahKaryawanBaru() {
  const karyawanBaru = {
    ...
    email: "nanikwijayani@majujaya.com",
    phone: "081234567890",
    ...
    address: {
      street: "Jl. Nusa Indah No. 179",
      suite: "Lantai 5",
      city: "Semarang", // ← Mengandung "s"
      zipcode: "34521",
    },
  };
...
function renderData(data) {
  ...
  if (isFilterActive) {
    ...
    console.log(
      `Filter diterapkan: ${dataToRender.length}/${data.length} karyawan dari kota dengan huruf "s"`,
    );
  }
